...
```{r}
april_2022_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - April 2022 (1)(Table 1).csv") |> pivot_date("April", "2022") 
...
```{r}
june_2022_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - June 2022(Table 1).csv", 
         skip = 1) |> pivot_date("June", "2022")
```

```{r}
july_2022_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - July 2022(Table 1).csv", 
         skip = 1) |> pivot_date("July", "2022")
```

```{r}
august_2022_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - August 2022(Table 1).csv", 
         skip = 1) |> pivot_date("August", "2022")
```

```{r}
september_2022_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - September 2022(Table 1).csv", 
...
```{r}
april_2023_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - April 2023(Table 1).csv", 
...
```{r}
june_2023_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - June 2023(Table 1).csv", 
...
```{r}
july_2023_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - July 2023(Table 1).csv", 
         skip = 1) |> pivot_date("July", "2023")
```

```{r}
august_2023_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - August 2023(Table 1).csv", 
         skip = 1) |> pivot_date("August", "2023")
```

```{r}
september_2023_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - September 2023(Table 1).csv", 
...
```{r}
april_2024_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - April 2024(Table 1).csv", 
         skip = 1) |> pivot_date("April", "2024")
```

```{r}
may_2024_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - May 2024(Table 1).csv", 
         skip = 1) |> pivot_date("May", "2024")
```

```{r}
june_2024_clean <- read_csv("data-original/indoor_all_csv/SB1R56 - June 2024(Table 1).csv", 
         skip = 1) |> pivot_date("June", "2024")
```
