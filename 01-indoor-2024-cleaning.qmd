...
The original PDFs were converted into xlsx files and downloaded as csv files using Adobe Acrobat, resulting in the csv files found in 'data-original' as 'SB1R56 - April 2024 (Table 1).csv' and so on for each month. The original documents are found in 'data-original/2024_indoor'. 


## Goals of this notebook

Clean and combine the 2024 indoor logs for April, May, June, July, August and September.
...
```{r}
indoor_temps_all |> filter(date == "2025-07-01")
```
