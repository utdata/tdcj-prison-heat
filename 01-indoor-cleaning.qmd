...
The original PDFs were transcribed into data using Google Pinpoint, resulting in the csv files found in `data-original`. The original documents are found in `data-original`.
