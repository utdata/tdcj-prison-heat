...
<!-- We should discuss how to note the initial_extreme_temp in the cleaned activation log. In some instances it's the same as the activation day, so that complicates charting it. -->
