...
Some space for checks ... In some cases we had the urls formatted incorrectly. Result should be 0 rows.
...
```{r}
logs_numbs |> write_rds("data-processed/01-outdoor-cleaned.rds")
```
