...
### Unanswered or of note

- Something we've yet to look at: there are cases where the log does not have a heat index `hi_wc` recorded, but there is a temperature and humidity. We could calculate that heat index when we have the data (and then compare to what the prison log has when it is present.)
