---
title: "2023 indoor logs cleaning old"
...
Note: this data was re-cleaned on Oct. 14, 2025 with the original pdf files converted to csv files using Adobe Acrobat rather than Google Pinpoint. The updated 2023 indoor logs cleaning can be found in the 01-indoor-2023-cleaning notebook on the emily branch. The the title and export file name of this notebook were updated to reflect this change.
...
*Note: this data was re-cleaned on Oct. 14, 2025 with the original pdf files converted to csv files using Adobe Acrobat rather than Google Pinpoint. The updated 2023 indoor logs cleaning can be found in the 01-indoor-2023-cleaning notebook on the emily branch. 
...
```{r}
daily_indoor_named |> write_rds("data-processed/01-indoor-cleaned-old.rds")
```
