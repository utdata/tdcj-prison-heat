...
- Are we interested in the exact time between initial temp and activation time? I THINK WE SHOULD BE. This could affect how we calculate when a unit _should_ be in protocol. Before 10/6 I was using `> 3` when perhaps it should be `>= 3`.
- Are we interested in the _number of hours_ a unit is under protocol, or is the day sufficient.
- I should add and keep the number of days between when first high temp noted and activation date.
...
I wanted to see how many days there typically were between the initial extreme temperature and the activation. 
...
Out of 102 activations in 2023, only one of them took place more than the 3rd day _after_ the "initial extreme temp".
